...
def find_model_file(dest_dir):  # this one better
    model_files = list(Path(dest_dir).glob("model.npz.best-chrf.npz"))
...
class OpusState:
    def __init__(self, source_dir, eos_token_id=0):
        ...
        # Process decoder.yml
        decoder_yml = cast_marian_config(load_yaml(source_dir / "model.npz.best-perplexity.npz.decoder.yml"))
